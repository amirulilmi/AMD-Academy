...
class Snap extends CI_Controller
{
	...
	public function finish()
	{
		...
		$simpan = $this->m_daftar->putOrder($result, 'midtrans');
		if ($simpan) {
			$inisial = $this->m_pelatihan->getInisial($this->session->userdata($this->s_id_pel))['inisial'];
			$this->session->set_flashdata('sukses_daftar', 'Berhasil melakukan pendaftaran');
			redirect(base_url('AMDA/deskripsi/' . $this->session->userdata($this->s_id_pel)));
		}

		$this->session->unset_userdata($this->s_id_pel);
		$this->session->unset_userdata($this->s_pilihan);
